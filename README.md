...
Η εργασία επικεντρώνεται στην εφαρμογή βασικών πρακτικών DevOps, 
χρησιμοποιώντας Docker ,Ansible και Jekins 
Ο βασικός στόχος της εργασίας είναι: 
1)Η εξοικείωση με τις DevOps πρακτικές 
2)Η αυτοματοποίηση διαδικασιών ανάπτυξης και deployment 
3)Η χρήση εργαλείων CI/CD 
4)Η διαχείριση υποδομών μέσω configuration management 
Οι τεχνολογιες που χρησιμοποιησαμε ειναι :  
1)Git / GitHub  για το Version Control 
2)Docker για το Containerization της εφαρμογής 
3)Jenkins για το  Continuous Integration / Continuous Deployment (CI/CD) 
4)Ansible για την Αυτοματοποιημένη διαχείριση και ρύθμιση συστημάτων 
...
docker-compose.yml : Εκκίνηση της εφαρμογής. -φτιάχνουμε repository- 
...
2. Εγκαθηστουμε  τα παρακάτω plugins: - Docker Pipeline - Git plugin - Pipeline - Maven Integration plugin 
